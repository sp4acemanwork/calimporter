    ...
    def run_conversion(self) -> None:
        ...
        try:
            ...
            if header_idx is None:
                status.update("Error: Could not find a row containing 'Meeting Patterns'.")
                return
            ...
            if events:
                ...
                status.update(f"Success! Saved to: {output_file}\nEvents: {len(events)}")
            else:
                status.update("No events were identified.")
